---
title: "Building My Blog With Claude AI — A Practical Step-by-Step Account"
...
image:
  ...
  alt: "Building My Blog With Claude AI"
---
...
The blog took about two weeks of evening sessions to build and refine. Without Claude, the same result would have taken significantly longer — not because the problems were unsolvable, but because each rabbit hole (rouge DOM structure, compress_html quirks, gem-based SCSS) would have required reading documentation and Stack Overflow threads rather than getting a direct, contextual answer.

The AI didn't replace understanding — I still needed to review and approve every change. But it compressed the gap between "I want this to work" and "it works" considerably.

---

<br>

*Running into something similar with your own Jekyll/Chirpy setup? Reach out on [LinkedIn](https://www.linkedin.com/in/robertmagasi/) — happy to help.*
